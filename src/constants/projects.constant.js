const projects = [
    {
        ...
        links: {
            code: 'https://github.com/imrhlrvndrn/alphacommerce-frontend',
            live_demo: 'https://alphareads.netlify.app/',
        },
    ...
    // },
    {
        title: 'Spotify Clone',
        description:
            "This is a Spotify Clone that uses the official 'spotify-web-api-js' to pull dynamic user data. You can also listen to a short preview of your favourite song",
        links: {
            code: 'https://github.com/imrhlrvndrn/spotify-clone',
            live_demo: 'https://spotifyreplica14.netlify.app',
        },
        tech_stacks: ['Spotify API', 'ReactJS', 'Styled-Components', 'Context API'],
        image_url: '/spotify_app.png',
    },
    {
        title: 'Netflix Clone',
        description:
