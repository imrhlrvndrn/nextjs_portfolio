...
// styles
import { ToggleSwitch as Toggle } from './toggle.styles';

export const ToggleSwitch = ({ children, onToggle, toggleState = false }) => {
    // const [toggleSwitch, setToggleSwitch] = useState(toggleState);
